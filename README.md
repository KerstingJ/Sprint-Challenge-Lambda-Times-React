...
- [x] What are PropTypes used for? Please describe why it's important to type check our data in JavaScript.
    * PropTypes are used to check the type of a value one a react components props object. Unintended types can lead to wonky behavior think `1 + '1' vs 1 + 1`
- [x] Describe a life-cycle event in React?
    * each component has certain phases it goes through from being created, mounted, updated, removed. React allows you to hook into these events to give you een more control of your react components
- [x] Explain the details of a Higher Order Component?
    * a Higher order Component is a function that takes 1 or more components as an argument and returns a component
- [x] What are three different ways to style components in React? Explain some of the benefits of each.
    * vanilla CSS - hard to keep track of sometimes but thats ol'faithful
    * styled components - lets you style components in JS giving you a ton of power and allows you to easily tell whats gonna be styled
    * import pre styled components - you know what they look like and how they act, just plug and play
## Project Setup
